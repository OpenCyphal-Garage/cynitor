...
- **Network topology** — D3 force-directed bipartite graph of device and subject nodes with directional pub/sub links. Drag-to-pin with persistent positions, adjacency highlighting, and a toggle to collapse subjects into device-to-device edges.
